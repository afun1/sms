...
if (window.location.pathname.toLowerCase().includes('login')) {
    ...
    // Only execute navigation code if we're not on login page
...
} // End of navigation execution block
